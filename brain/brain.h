...
void call_parallelogram(int choice, int rows, int cols, char symbol, char borderColor, char fillColor, int x, int y);
...
void call_alphabets(char symbol, char borderColor, int x, int y, int size, int choice, char start, char end);